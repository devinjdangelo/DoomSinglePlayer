...
class DoomSimulator:
    ...
    def process_game_vars(self,m_raw,labels):
        ...
        self.episode_hits.append(m_raw[-1])
        ...
        if len(self.level_xpos) > 1:
            ...
            if self.episode_hits[-1]>self.episode_hits[-2]:
                print('You scored a hit!',self.episode_hits[-1]-self.episode_hits[-2])
                self.hits += 1
